...
st.info(
    """
    This analysis establishes the fundamental predictors of student performance, focusing on academic history and crucial habits. 
    The scatter plot demonstrates a **strong positive correlation between prior success (HSC) and current academic standing (Last Score)**, affirming that past achievement provides a critical foundation. 
    The Mean Overall CGPA is heavily influenced by **attendance**, which shows a direct, positive causal link to performance. 
    Most notably, the correlation heatmap identifies the **Last Semester Score as the single best predictor** of the Overall CGPA. 
    While study habits and attendance are essential contributing factors, sustained academic achievement in the university environment is the most reliable indicator of future success.
    """
)
